...
#Initializer
initializer_1 = CustomAboveOneInitializer(min_value=-1, max_value=1)
initializer_2 = CustomAboveOneInitializer(min_value=-0.3, max_value=0.3)
...
for i in range(100):
    ...
    initializer_1 = CustomAboveOneInitializer(min_value=-i*0.01, max_value=i*0.01)
    ...
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(100,activation='tanh',kernel_initializer=initializer_1),
        tf.keras.layers.Dense(num_classes, activation='softmax')
    ])
